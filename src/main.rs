...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    .with_select(SelectElite::new(0.3, 0.0625))         // sort the chromosomes by fitness to determine crossover order. Strive to replace 50% of the population with offspring. Allow 2% through the non-generational best chromosomes gate before selection and replacement
