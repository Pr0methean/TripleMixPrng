...
fn permute_sparx64(input: Simd64) -> Simd64 {
        ...
        /* odd increment */
        let inc = (Simd::splat(1) << (Simd::splat(37) ^ shift)) + (count << 8);
...
fn mix(w_lo: Simd64, x_in: Simd64, t: Simd64, w_hi: Simd64, i: Simd64) -> (Simd64, Simd64) {
    ...
    let y = (l0_2 ^ r1_2) + (l1_2 >> MIXING_ROTATION_12);
...
mod tests {
    ...
    fn test_cross_platform_reproducibility() {
        ...
        let expected = "";
