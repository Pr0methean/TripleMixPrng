...
fn mix(w_lo: Simd64, x_in: Simd64, t: Simd64, w_hi: Simd64, i: Simd64) -> (Simd64, Simd64) {
    ...
    let second_mix_wx_rotated = second_mix_with_i_hi ^ rotl(wx, MIXING_ROTATION_01);
    let r0_1 = (t ^ second_mix_wx_rotated) + w_lo;
...
mod tests {
    ...
    fn test_cross_platform_reproducibility() {
        ...
        let expected = "";
