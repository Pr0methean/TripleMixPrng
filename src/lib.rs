...
fn mix(w_lo: Simd64, x_in: Simd64, t: Simd64, w_hi: Simd64, i_hi: Simd64) -> (Simd64, Simd64) {
    ...
    let r0_1 = (t ^ rotl(second_mix_with_i_hi ^ l1_1, MIXING_ROTATION_01)) + w_lo;
    let r1_1 = l0_1 + r0_1;
...
mod tests {
    ...
    fn test_cross_platform_reproducibility() {
        ...
        let expected = "DEA610F95B3B4103DEE455F525A68DAE944320B8937C41C69295B0D0AE52A0F8\
            36BB7EB636DB8126DCB5F41B6F2BDAD61EFF66894AF6430968B1E4881F6D28F9\
            50194102F508FB718D5AEFD7DE3F2FEEFA2B3D691C184B28AE316A024F63ECDA\
            8F6D294DAACDC15BBBBF7CC660FF6C8377C485B8C023175C321D4144EF08CEC8\
            963314FD6B6085634936B7BF3D7A12A5CF1CE709520C64FD423B36AF188B4601\
            712D551D0DE44CABD60A0F34F8103E898384958B1D6834DBCB4C4E12E8DF4D99\
            B2267D2169F3617B01377AF7B2A8D99C688FFF39D8012053165107D02028C00C\
            4ACAA4D67C5FDA08E9AB8A78D63CFD471C86F443B5842953EF04F42C93F5D111";
